...
SECRET_KEY = 'django-insecure-(v0%v@vy%9uc=+t3@q!rdf6$k5!geauvdzu(ixf7@)_t!4f1_1'
...
AUTH_USER_MODEL = 'mambaling.CustomUser'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'mambaling', 'static'),
]
